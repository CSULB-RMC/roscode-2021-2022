...
class JoyToTeensyPublisher(Node):
    def __init__(self):
        ...
        self.joy_sub #dumb. used to supress unused var warning
    ...
    def joy_callback(self, msg):
        ...
        if curbed > 127:
            curbed = 127
        curbed_b.data = curbed.to_bytes(1, 'little')
        self.dt_left_pub.publish(curbed_b)
        ...
        curbed2_b.data = curbed.to_bytes(1, 'little')
        self.dt_right_pub.publish(curbed2_b)
